...
const TermsAndConditions = () => {
  ...
  return (
    <div className="max-w-11/12 mx-auto min-h-screen bg-white text-slate-900 font-sans selection:bg-[#7b5e00] selection:text-white">
      <header className="relative overflow-hidden bg-slate-50/50 border-b border-slate-100 py-10 px-6">
        <div className="max-w-6xl mx-auto text-center">
          <motion.div initial="initial" animate="animate" variants={fadeInUp}>
            <span className="inline-block py-1.5 px-4 rounded-full bg-[#7b5e00]/10 text-[#7b5e00] font-bold text-xs mb-6 uppercase tracking-widest border border-[#7b5e00]/20">
              Official Terms and Conditions
            </span>
            <h1 className="text-5xl md:text-8xl font-black mb-8 tracking-tight text-slate-900">
              Welcome to <br />
              <span style={{ color: primaryColor }}>USFRANC (USFC)</span>
            </h1>
      ...
      <main className="max-w-6xl mx-auto px-6 py-20">
        <section className="grid lg:grid-cols-2 gap-16 items-start mb-32">
          <motion.div
            ...
            <div className="p-6 bg-[#7b5e00]/5 rounded-3xl border border-[#7b5e00]/10">
          ...
          <motion.div
            ...
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#7b5e00] opacity-20 blur-[100px] group-hover:opacity-40 transition-opacity" />
            <h3 className="text-2xl font-bold mb-8 flex items-center gap-3">
              <Zap className="text-[#7b5e00]" /> Network Architecture
            </h3>
            <div className="space-y-6">
              <div className="flex justify-between items-center border-b border-white/10 pb-4">
                <span className="text-white/60">Blockchain Type</span>
                <span className="font-mono text-[#7b5e00] font-bold">
                  Hybrid PoW/PoS
                </span>
              </div>
              <div className="flex justify-between items-center border-b border-white/10 pb-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-32">
          <motion.div
            ...
            <h3 className="text-2xl font-black uppercase tracking-tighter flex items-center gap-4">
              <span className="h-1 w-12 bg-[#7b5e00]" /> What USFRANC IS
            </h3>
            <div className="grid gap-4">
              {[
                ...
                <motion.div
                  ...
                  <h4 className="font-bold text-[#7b5e00] mb-2">{item.t}</h4>
        ...
        <section className="mb-24">
          <div className="bg-slate-50 rounded-[3rem] p-12 md:p-20 border border-slate-100">
            <div className="max-w-3xl mb-16">
              <h2 className="text-4xl font-black mb-6">USFRANC Usage Policy</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="flex gap-6 group">
                <div className="h-14 w-14 shrink-0 rounded-2xl bg-white flex items-center justify-center shadow-sm text-[#7b5e00] group-hover:bg-[#7b5e00] group-hover:text-white transition-colors duration-300">
              ...
              <div className="flex gap-6 group">
                ...
                <div>
                  <h4 className="font-bold text-lg mb-2">Merchant Payments</h4>
                  <p className="text-slate-500 text-sm">
              ...
              <div className="flex gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-sm">
                    USFC complies with applicable cryptocurrency regulations in
          ...
          <div className="grid lg:grid-cols-3 gap-12 mb-16">
            <div className="lg:col-span-2">
              ...
              <p className="text-slate-500 leading-relaxed max-w-2xl">
                By using USFRANC (USFC), you acknowledge that you understand the
                inherent risks associated with cryptocurrency and decentralized
                finance. USFC does not guarantee the stability of the value of
                the currency and is not responsible for any losses or gains
