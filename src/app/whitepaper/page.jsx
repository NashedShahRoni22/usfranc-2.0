  ...
  return (
    <div className="min-h-screen bg-[#fafaf9] text-slate-900 font-sans selection:bg-[#7b5e00] selection:text-white">
      <header className="bg-white border-b border-slate-200 pt-10 md:pt-32 pb-16 px-6 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-1/4 h-full bg-[#7b5e00]/5 -skew-x-12 translate-x-20" />
          ...
          <motion.div
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <span className="px-3 py-1 bg-[#7b5e00] text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-md">
                  Official Documentation
                </span>
              </div>
              <h1 className="text-5xl md:text-7xl font-black tracking-tighter">
                USFRANC <span style={{ color: primaryColor }}>Whitepaper</span>
              </h1>
          ...
          {activeTab === "global" ? (
            <motion.div
              ...
              <div className="bg-white p-8 md:p-12 rounded-[2.5rem] border border-slate-200 shadow-sm relative overflow-hidden">
                <div className="absolute top-0 left-0 w-2 h-full bg-[#7b5e00]" />
                <h2 className="text-3xl font-black mb-2 text-slate-900">
                  USFRANC Whitepaper
                </h2>
                <p className="text-[#7b5e00] font-bold mb-6">
                ...
                <h3 className="text-xl font-black mb-4 flex items-center gap-2">
                  <ChevronRight size={20} className="text-[#7b5e00]" /> 1.
                  Introduction
                </h3>
                <p className="text-slate-600 leading-relaxed">
                  ...
                  and Proof of Stake (PoS). It is designed to preserve capital,
                  offer practical utility for real-world transactions, and
                  deliver secure, transparent governance through community
                  involvement and smart contract automation. The mission of
                  USFranc is to deliver a next-generation cryptocurrency that
                  balances decentralization, compliance, investor protection,
                  and usability, while ensuring resilience through its hybrid
                  technical structure and financial reserve model.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <section className="space-y-6">
                  <div className="p-8 bg-slate-50 rounded-[2rem] border border-slate-100">
                    ...
                    <p className="mt-6 text-xs text-slate-500 italic">
                      ...
                      pre-issued, meaning there will be no further inflationary
                      minting. This fixed-cap model protects value and
                      simplifies economic planning for both retail users and
                  ...
                  <div className="p-8 bg-white rounded-[2rem] border border-slate-200">
                    ...
                    <p className="text-sm text-slate-600 leading-relaxed">
                      ...
                      protocol. However, due to cybersecurity considerations and
                      the need to preserve operational integrity, critical
                      modules (e.g., validator logic, ledger protocol,
                      compliance triggers) are made available only on request to
                      vetted developers, auditors, or institutional partners.
                      The public GitHub repository contains the basic wallet
                      infrastructure, wrapped token smart contracts, and
                      interoperability components. All forks or derivative
                      chains must first undergo a security and compliance audit
                      by the USFranc Reserve Management Entity.
                    </p>
                  </div>
                </section>
                ...
                <section className="space-y-6">
                  <div className="p-8 bg-slate-900 text-white rounded-[2rem] relative overflow-hidden">
                    ...
                    <h3 className="text-xl font-black mb-6 flex items-center gap-2 text-[#7b5e00]">
                      <Zap size={20} /> 4. Blockchain Architecture
                    </h3>
                    <ul className="space-y-4 text-sm font-bold">
                      <li className="flex flex-col">
                        <span className="text-[#7b5e00] text-[10px] uppercase">
                          Base Chain
                        </span>{" "}
                        <span>
                    ...
                    <p className="mt-4 text-xs text-slate-400 font-normal italic">
                      USFranc’s chain is both secure and scalable. The Litecoin
                      forked PoW ensures traditional miner validation and
                      hardware compatibility, while the Komodo PoS integration
                      provides flexibility for optional staking, notarization,
                      and smart contract expansion.
                    </p>
                  </div>
                </section>
              </div>
              ...
              <div className="p-8 md:p-12 bg-white rounded-[3rem] border border-slate-200">
                <h3 className="text-2xl font-black mb-8 flex items-center gap-3">
                  <Landmark className="text-[#7b5e00]" /> 5. Capital Allocation
                  Strategy
                </h3>
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                  <div className="p-6 bg-slate-50 rounded-2xl">
                    <div className="text-4xl font-black text-[#7b5e00] mb-2">
                      67%
                    </div>
                ...
                <p className="p-4 bg-[#7b5e00]/5 border border-[#7b5e00]/20 rounded-xl text-xs text-slate-600 italic">
                  Importantly, ownership of hedge capital is retained by
                  USFranc’s Reserve Management Entity (SAS Affin). Coin holders
                  do not receive direct financial rights over the reserves but
                  benefit from the macroeconomic protection they offer.
                </p>
              </div>
              ...
              <div className="space-y-8">
                <div className="p-8 bg-white rounded-[2rem] border border-slate-200">
                    ...
                    <table className="w-full text-left text-xs">
                      ...
                      <tbody className="divide-y">
                        ...
                        <tr>
                          ...
                          <td className="p-4 text-green-600">100% unlocked</td>
                  ...
                  <p className="mt-4 text-xs text-slate-500">
                    ...
                    enforceable via optional escrow contracts or compliance node
                    reviews for large sales.
                  </p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="p-8 bg-white rounded-3xl border border-slate-200">
                  ...
                  <ul className="space-y-2 text-xs font-bold">
                    <li className="flex justify-between">
                      ...
                      <span className="text-[#7b5e00]">10%</span>
                    </li>
                    <li className="flex justify-between">
                      <span>Capital Reserve</span>{" "}
                      <span className="text-[#7b5e00]">20%</span>
                    </li>
                    <li className="flex justify-between">
                      <span>Operational</span>{" "}
                      <span className="text-[#7b5e00]">70%</span>
                    </li>
                  </ul>
                </div>
                <div className="md:col-span-2 p-8 bg-white rounded-3xl border border-slate-200">
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed mb-4">
                    ...
                    counter-terrorist financing (CTF) procedures. All purchases
                    above €50,000 (or equivalent in crypto or fiat) are subject
                    to Enhanced Due Diligence (EDD), including:
                  </p>
              ...
              <div className="p-12 bg-slate-50 rounded-[3rem] border border-slate-200">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  <div>
                    <h4 className="font-black text-[#7b5e00] text-sm mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-600">
                      ...
                      (encrypted, 31-day rotating, updated daily) using AES-256
                      and cryptographic integrity via hashed logging.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <section className="space-y-8">
                <div className="p-8 bg-slate-900 text-white rounded-3xl">
                  <h3 className="text-xl font-black mb-6 text-[#7b5e00]">
                  ...
                  <p className="mt-6 text-sm text-slate-400">
                    ...
                    cross-chain usability --- with security and value protection
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="p-8 bg-white border border-slate-200 rounded-3xl">
                    ...
                    <p className="text-sm font-bold">
                      Founder: <span className="text-[#7b5e00]">Brian Fin</span>
                    </p>
                    <p className="text-sm font-bold">
                      Co-Founder:{" "}
                      <span className="text-[#7b5e00]">SAS Affin</span>
                    </p>
                    <p className="text-sm font-bold">
                      First Issuing Entity:{" "}
                      <span className="text-[#7b5e00]">
                  ...
                  <div className="p-8 bg-white border border-slate-200 rounded-3xl">
                    <h3 className="text-xl font-black mb-4 flex items-center gap-2">
                      <MapPin className="text-[#7b5e00]" /> 12. Our Locations
                    </h3>
              ...
              <div className="p-12 bg-white rounded-[3rem] border border-slate-200">
                ...
                <p className="text-sm text-slate-600 leading-relaxed mb-10">
                  ...
                  clarity, transparency, and operational sustainability. The 2%
                  transaction fee collected after the coin launch is distributed
                  as follows: 10% to the Capital Hedge Fund, 20% to the Capital
                  Reserve Wallet, and 70% to the Operational Cost Wallet.
                </p>
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  The USFranc platform includes a secure, voluntary escrow-based
                  wallet system for merchants and crypto holders. In this setup:
                  Crypto holders can choose to activate an escrow mode at the
                  time of payment. USFranc will temporarily hold the payment in
                  escrow for 7 days or until delivery is confirmed. This
                  optional feature provides transactional security, builds buyer
                  trust, and enhances merchant credibility. The system is not
                  enforced and is voluntarily used by both parties to improve
                  accountability and trust in crypto payments.
                </p>
              </div>
              ...
              <div className="p-8 bg-slate-50 rounded-3xl">
                ...
                <p className="text-xs font-bold text-[#7b5e00] mb-4">
                ...
                <div className="grid md:grid-cols-3 gap-6 text-[10px] font-bold text-slate-500 leading-loose">
                  <p>
                    ...
                    cryptocurrency that is neither a security nor a stablecoin.
                  </p>
                  <p>
                    <span className="text-slate-900 block">
                      Use Case Limitation:
              ...
              <div className="p-12 bg-white rounded-[3rem] border border-slate-200">
                <div className="grid md:grid-cols-2 gap-12">
                  <div>
                    ...
                    <p className="text-xs font-bold text-slate-600">
                      Native Hybrid PoW/PoS Coin (Forked from Komodo + Litecoin
                      Core)
                      <br />
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-600">
                      ...
                      custom blockchain infrastructure using Komodo and Litecoin
                      components. Mainnet Chain uses Komodo’s SmartChain
                      framework.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-12 p-4  md:p-8 bg-slate-50 rounded-2xl">
                  ...
                  <p className="text-xs text-slate-600 mb-6">
                    ...
                    compatibility with Binance Smart Chain wallets such as Trust
                    Wallet and MetaMask. wUSF is pegged 1:1 to the native USFC.
                  </p>
                ...
                <div className="mt-12">
                  <h3 className="text-xl font-black mb-4">20. Mining Policy</h3>
                  <p className="text-xs text-slate-600 leading-loose">
                    ...
                    apply node authorization and IP-based limitations to control
                    participation. No Reward Dilution: Mining rewards are
                    algorithmically fixed and distributed only to verified
                    mining addresses. Supply Integrity: A maximum supply cap of
                    1,000,000,000 USFC is enforced. No new coins beyond this
                    issuance. Admin Monitoring: A compliance node will verify
                    large transactions and trace transaction origin to prevent
              ...
              <div className="space-y-8">
                <div className="flex flex-col md:flex-row gap-8">
                  <div className="flex-1 p-8 bg-[#7b5e00] text-white rounded-3xl">
                    <h3 className="text-xl font-black mb-4">
                  ...
                  <div className="flex-1 p-8 bg-white border border-slate-200 rounded-3xl">
                    ...
                    <p className="text-[10px] text-slate-500 font-bold uppercase leading-relaxed">
                      USFranc is a decentralized cryptocurrency, not a security.
                      By engaging with USFranc: You acknowledge you hold and
                      manage your wallet and funds independently. USFranc Ltd,
                      SAS Affin, or its affiliates are not liable for user
                      errors, third-party breaches, or losses from misuse. You
                      agree to abide by AML/CTF, tax laws, and crypto
                ...
                <div className="p-12 bg-white rounded-[3rem] border border-slate-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-5 gap-6 text-[10px] font-black text-center text-[#7b5e00] uppercase">
                    <div className="space-y-2">
                      <div className="h-1 bg-[#7b5e00] w-full mb-4" />
                      Hybrid Blockchain
                    </div>
                    <div className="space-y-2">
                      <div className="h-1 bg-[#7b5e00] w-full mb-4" />
                ...
                <div className="p-12 bg-slate-900 text-white rounded-[3rem]">
                  <h3 className="text-2xl font-black mb-6 text-[#7b5e00]">
                  ...
                  <p className="text-sm text-slate-400 mb-8">
                    ...
                    Komodo’s SmartChain modules for energy-efficient validation.
                  </p>
                ...
                <div className="p-12 bg-white rounded-[3rem] border border-slate-200">
                  ...
                  <div className="space-y-4 text-xs font-bold text-slate-500">
                    ...
                    <p>
                      ...
                      A 31-day rolling read-only backup of the General Ledger is
                      encrypted and mirrored daily. It ensures recoverability
                      without everyday surveillance.
                    </p>
                    <p>
                      <span className="text-slate-900 block font-black">
                        Escrow Framework (Voluntary):
                      </span>{" "}
                      Holds merchant transactions in smart contracts for 7 days
                      post-delivery confirmation. Participation is voluntary.
                    </p>
                  </div>
                </div>

                <div className="p-16 bg-[#7b5e00] text-white rounded-[4rem] text-center">
                  ...
                  <p className="max-w-3xl mx-auto text-sm opacity-80 leading-relaxed mb-8">
                    ...
                    crypto use in the real world. All development and compliance
                    operations are fully administered by SAS Affin and USFranc
                    Ltd, with ongoing updates provided through
                    https://usfranc.com.
                  </p>
                ...
                <div className="space-y-12">
                  <section>
                    ...
                    <p className="text-sm text-slate-600 leading-relaxed">
                      ...
                      les paiements réels, combinant des mécanismes de consensus
                      Proof of Work (PoW) et Proof of Stake (PoS). Le projet
                      vise à fournir une monnaie numérique stable, sécurisée et
                      conforme pour les transactions en ligne et en point de
                      vente.
                    </p>
                  </section>
                  ...
                  <section>
                    ...
                    <p className="text-sm text-slate-600 leading-relaxed">
                      ...
                      transaction inspiré de l’entiercement est intégré afin de
                      bloquer les fonds jusqu’à la validation de la livraison.
                    </p>
                  </section>
                  ...
                  <section className="p-8 bg-slate-900 text-white rounded-3xl">
                    <h3 className="text-xl font-black mb-4 text-[#7b5e00]">
                      4. Architecture Technique
                    </h3>
                    <p className="text-sm text-slate-400">
                      USFRANC repose sur une blockchain à double couche : un
                      réseau principal basé sur un fork de Litecoin (PoW) et une
                      sidechain PoS pour les contrats intelligents. Ce modèle
                      hybride garantit une validation efficace et une haute
                  ...
                  <section className="p-8 bg-[#7b5e00]/5 border border-[#7b5e00]/20 rounded-3xl">
                    <h3 className="text-xl font-black mb-4 text-[#7b5e00]">
                      6. Stratégie de Réserve de Capital
                    </h3>
                    <p className="text-sm text-slate-600 leading-relaxed">
                      Au moins 67 % du capital net issu des premières ventes est
                      alloué à des réserves sûres (ex : obligations d’État). Ces
                      réserves ne constituent pas un fonds mutualisé ni un actif
                      accessible aux utilisateurs. Aucun rendement, dividende ou
                      droit n’est accordé. Cette stratégie renforce l’intégrité
                      opérationnelle.
                    </p>
                  </section>
                  ...
                  <section>
                    ...
                    <p className="text-sm text-slate-600 leading-relaxed">
                      ...
                      comme une cryptomonnaie. Aucun rendement ou droit sur les
                      actifs n’est garanti. Les utilisateurs assument le risque
                      total de perte.
                    </p>
                  </section>
                  ...
                  <div className="space-y-6 pt-12 border-t border-slate-100">
                    ...
                    <p className="text-[10px] text-slate-500 font-bold uppercase">
                      10. Transparence: Tous les documents sont publiés en FR et
                      EN. Gouvernance auditée. Contact : compliance@usfranc.com
                    </p>
                    <p className="text-[10px] text-slate-400 font-bold text-center italic mt-10">
                      Clause de non-responsabilité : Cette déclaration de
                      conformité est fournie à titre informatif uniquement et ne
                      constitue pas un conseil juridique ou financier.
                    </p>
                  </div>
                </div>
              </div>
